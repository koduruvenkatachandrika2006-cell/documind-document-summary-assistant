...
import { AskDocumentModal } from './components/AskDocumentModal.js';
...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100 font-sans antialiased">
      ...
      {/* Reserve Top Padding (pt-24 sm:pt-28) to prevent navbar content overlap */}
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 pt-24 sm:pt-28 pb-12">
        
        {/* LANDING / UPLOAD VIEW */}
        {!isProcessing && !processedDoc && !errorMessage && (
          <div className="flex flex-col items-center text-center space-y-8 my-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-left">
                ...
                <div className="surface-card p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400 mt-0.5">AI surface key points, improvements, & answers.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {isChatOpen && processedDoc && (
        <AskDocumentModal
          documentId={processedDoc.id}
          documentText={processedDoc.extractedText}
